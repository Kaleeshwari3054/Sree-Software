...
// =======
//                 <div className="position-absolute top-0 end-0 h-100 bg-danger opacity-20"></div>
// >>>>>>> 0e0313413fbd7b118946b57cbc5a81c4e7a3529e
              ...
              <div className="card-body p-5">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-4">
                    ...
                    {errors.name && (
                      <div className="invalid-feedback d-block mt-2">
                        <i className="bi bi-exclamation-circle-fill me-2 text-danger"></i>{errors.name}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    {errors.company && (
                      <div className="invalid-feedback d-block mt-2">
                        <i className="bi bi-exclamation-circle-fill me-2 text-danger"></i>{errors.company}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="mb-4">
                    ...
                    {errors.phone && (
                      <div className="invalid-feedback d-block mt-2">
                        <i className="bi bi-exclamation-circle-fill me-2 text-danger"></i>{errors.phone}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="row g-4 mb-4">
                    <div className="col-md-6">
                      ...
                      {errors.email && (
                        <div className="invalid-feedback d-block mt-2">
                          <i className="bi bi-exclamation-circle-fill me-2 text-danger"></i>{errors.email}
                        </div>
                      )}
                    </div>
                    <div className="col-md-6">
                      ...
                      {errors.place && (
                        <div className="invalid-feedback d-block mt-2">
                          <i className="bi bi-exclamation-circle-fill me-2 text-danger"></i>{errors.place}
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="mb-5">
                    ...
                    {errors.state && (
                      <div className="invalid-feedback d-block mt-2">
                        <i className="bi bi-exclamation-circle-fill me-2 text-danger"></i>{errors.state}
                      </div>
                    )}
                  </div>
                  ...
                  <button 
                    type="submit"
                    disabled={isLoading}
                    className="w-100 btn btn-danger btn-lg py-3 px-5 fw-semibold rounded-3 shadow-md hover:shadow-lg transform hover:-translate-y-px transition-all duration-200 border-0 position-relative overflow-hidden disabled:opacity-75 disabled:cursor-not-allowed"
                  >
                    {isLoading ? (
                      <>
